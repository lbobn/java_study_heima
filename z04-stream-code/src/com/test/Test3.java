    ...
    public static void main(String[] args) {
      ...
      */
        ...
        Stream<String> manStream = manList.stream()
                ...
                .limit(2);
        //4.女演员只要姓杨的，并且不要第一个
        Stream<String> womenStream = womenList.stream()
                .filter(s -> s.split(",")[0].startsWith("杨"))
                .skip(1);
        //5.把过滤后的男演员姓名和女演员姓名合并到一起
        //演员信息封装成Actor对象。
        /*Stream.concat(manStream,womenStream).map(new Function<String, Actor>() {
            @Override
        ...
        List<Actor> list = Stream.concat(manStream, womenStream)
